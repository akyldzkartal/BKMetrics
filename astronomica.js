...
//  Siteden veri cekme 
const scrape = async () => {
    const url = 'https://web.telegram.org/k/#@AstronomicaNews';
    const cssSelector = '#column-center > div > div > div:nth-child(3) > div:nth-child(2) > div:nth-child(2) > section:nth-child(2) > div:nth-child(9) > div > div > div > div:nth-child(2) > span:nth-child(1)'; // twitter kismi
    ...
    try {
        ...
        const text = await page.evaluate(() => {
            const element = document.querySelector('#column-center > div > div > div:nth-child(3) > div:nth-child(2) > div:nth-child(2) > section:nth-child(2) > div:nth-child(9) > div > div > div > div:nth-child(2) > span:nth-child(1)');
